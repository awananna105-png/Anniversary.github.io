...
<head>
    ...
    <title>4 Years of Us - Our 4th Anniversary</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('editBtn').addEventListener('click', function () {
                ...
                setTimeout(() => {
                    const editChoice = confirm("Would you like to:\n\n1. Edit text content (Click OK)\n2. Change images (Click Cancel for instructions)");

                    if (editChoice) {
                        // Make all text editable
                        const editableElements = document.querySelectorAll('.photo-title, .photo-caption, .message-content p, .quote-text, .quote-translation');

                        editableElements.forEach(element => {
                            element.contentEditable = true;
                            element.style.borderBottom = "2px dashed var(--gold)";
                        ...
                        alert("You can now edit all text on the page! Click on any text to edit it, then press Enter when done.");
                    } else {
                        alert("To change images:\n\n1. Right-click on any image\n2. Select 'Inspect' or 'Inspect Element'\n3. Find the 'src' attribute in the code\n4. Replace the URL with your own image URL\n5. The image will update automatically!");
                    }
                }, 500);
            });
